        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              padding: padding,
              child: Text(
                '5. Which of the following best explains why SARS-CoV-2 (the virus that causes COVID-19) is more transmissible than SARS-CoV-1, despite having a lower fatality rate?',
              ),
            ),
