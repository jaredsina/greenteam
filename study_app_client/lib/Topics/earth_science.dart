...
class EarthScience extends StatefulWidget {
  final String title = 'Earth Science';

  const EarthScience({super.key});

  @override
  _EarthScienceState createState() => _EarthScienceState();
}
class _EarthScienceState extends State<EarthScience> {
  @override
      ...
      const SizedBox(width: 20, height: 20,),
       Row(
        ...
        onPressed: () {
          ...
          createPost(context, 'earth science', jsoncontent);
                },
       child:  Center(
        child: const Text(
                  'Save',
