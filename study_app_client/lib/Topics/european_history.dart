...
class EuropeanHistory extends StatefulWidget {
  final String title = 'European History';

  const EuropeanHistory({super.key});

  @override
  _EuropeanHistoryState createState() => _EuropeanHistoryState();
}
class _EuropeanHistoryState extends State<EuropeanHistory> {
      ...
      const SizedBox(width: 20, height: 20,),
       Row(
        ...
        onPressed: () {
          ...
          createPost(context, 'European History', jsoncontent);
                },
       child:  Center(
        child: const Text(
                  'Save',
