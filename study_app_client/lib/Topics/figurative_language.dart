...
class FigurativeLanguage extends StatefulWidget {
  final String title = 'Figurative Language';

  const FigurativeLanguage({super.key});

  @override
  _FigurativeLanguageState createState() => _FigurativeLanguageState();
}
class _FigurativeLanguageState extends State<FigurativeLanguage> {
  @override
      ...
      const SizedBox(width: 20, height: 20,),
       Row(
        ...
        onPressed: () {
          ...
          createPost(context, 'figurative language', jsoncontent);
                },
       child:  Center(
        child: const Text(
                  'Save',
